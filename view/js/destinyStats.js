$.ajaxSetup({ cache: false }); //removes caching
...
function loadData(){ //start function
	$.getJSON("info.json", 
		function(data){
			...
			//Loading Images
			$( ".characterPlate.elyril" ).css( "background-image", "url(img/" + data.Eskimo.background + ")" );
			$( ".emblem.elyril" ).css( "background-image", "url(img/" + data.Eskimo.emblem + ")" );
			$( ".characterPlate.solo" ).css( "background-image", "url(img/" + data.Solo.background + ")" );
			$( ".emblem.solo" ).css( "background-image", "url(img/" + data.Solo.emblem +")" );
			$( ".characterPlate.tigress" ).css( "background-image", "url(img/" + data.Tigress.background + ")" );
			$( ".emblem.tigress" ).css( "background-image", "url(img/" + data.Tigress.emblem + ")" );
			$( ".cruciblePlate" ).css( "background-image", "url(img/Crucible.BG.jpg)" );
			$( ".emblem.crucible" ).css( "background-image", "url(img/Crucible.EM.jpg)" );
